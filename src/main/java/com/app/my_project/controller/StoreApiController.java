...
public class StoreApiController {
    ...
    @PutMapping("/{id}")
    public StoreEntity putStore(@PathVariable Long id, @RequestBody StoreEntity storeEntity) {
    ...
    @PostMapping("/import")
    public StoreImportEntity importData(@RequestBody StoreImportEntity storeImportEntity) {
